...
<?php
        ...
        <div class="col-sm-7">
            <div class="row">
               <div class="col-xs-12">
                    ...
                    <div class="product-model">MODEL RM201</div>
                    <div class="product-tag">Hand Held And Colored</div>
                </div>
                <div class="col-xs-12" align="center">
                    <h3 lang="ar">جهاز مذياع بثلاث موجات </h3>
                    <h3 lang="ar">SW - MW - FM</h3>
                    <h3 lang="ar">صغير ومحمول باليد</h3>
                    <h3 lang="ar"> متوفر بعدة الوان </h3>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
                ...
                <div calss="col-xs-12">
                    <div class="zoom-section">
                        <div class="zoom-small-image">
                            <a href='products/RM201.png' class='cloud-zoom' rel="position:'inside',showTitle:false,adjustX:-4,adjustY:-4">
                                <img class="product-img" src="products//RM201.png" />
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-xs-12  catagory-back" style="background-image: url(image/Back-Radio.jpg);" align="center">
            <a id="prev" href="RM204.php" class="Next-Prev btn btn-1">
