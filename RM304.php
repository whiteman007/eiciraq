...
<?php
        ...
        <div class="col-sm-7">
            <div class="row">
               <div class="col-xs-12">
                    ...
                    <div class="product-model">MODEL RM304</div>
                    <div class="product-tag">With Remote And MP3 Player</div>
                </div>
                <div class="col-xs-12" align="center">
                    <h3 lang="ar">جهاز مذياع بثلاث موجات </h3>
                    <h3 lang="ar">SW - MW - FM</h3>
                    <h3 lang="ar"> MP3 ومشغل </h3>
                    <h3 lang="ar"> مع جهاز تحكم عن بعد </h3>
                </div>
                <div id="radio-remote" class="col-xs-12"></div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="row">
                <div calss="col-xs-12">
                    <div class="zoom-section">
                        <div class="zoom-small-image">
                            <a href='products/RM304.png' class='cloud-zoom' rel="position:'inside',showTitle:false,adjustX:-4,adjustY:-4">
                                <img class="product-img" src="products//RM304.png" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-2 specs-icon">
                    <img src="image/radio/USB.png" />
                </div>
                <div class="col-xs-2 specs-icon">
                    <img src="image/radio/Mp3.png" />
                </div>
                <div class="col-xs-2 specs-icon">
                    <img src="image/radio/acdc.png" />
                </div>
                <div class="col-xs-2 specs-icon">
                    <img src="image/radio/remote.png" />
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12  catagory-back" style="background-image: url(image/Back-Radio.jpg);" align="center">
            <a id="prev" href="RM305.php" class="Next-Prev btn btn-1">
                <span class="txt">PREVIOUS السابق</span>
                <span class="round"><i class="fa fa-chevron-right"></i></span>
            </a>
            <a id="next" href="RM301.php" class="Next-Prev btn btn-1">
