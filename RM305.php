...
<?php
        ...
        <div class="col-sm-7">
            <div class="row">
               <div class="col-xs-12">
                    ...
                    <div class="product-model">MODEL RM305</div>
                ...
                <div calss="col-xs-12">
                    <div class="zoom-section">
                        <div class="zoom-small-image">
                            <a href='products/RM305.png' class='cloud-zoom' rel="position:'inside',showTitle:false,adjustX:-4,adjustY:-4">
                                <img class="product-img" src="products//RM305.png" />
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-xs-12  catagory-back" style="background-image: url(image/Back-Radio.jpg);" align="center">
            <a id="next" href="RM304.php" class="Next-Prev btn btn-1">
